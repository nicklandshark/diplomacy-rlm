...
## F1903R
Retreat phase. Orderable: ['NWY']
Orders submitted.


## W1903A - Adjustment Phase
- Centers: ['EDI', 'LON', 'LVP'] (3)
- Units: ['A EDI', 'F BAR'] (2)
- Orders submitted: ['F LON B']
...
- All powers' units: {'AUSTRIA': ['A SER', 'F ALB', 'A BUD', 'A TRI'], 'ENGLAND': ['A EDI', 'F BAR'], 'FRANCE': ['A BUR', 'A GAS', 'A MAR', 'F MAO'], 'GERMANY': ['F DEN', 'A RUH', 'A BER', 'A MUN', 'A HOL'], 'ITALY': ['A NAF', 'F ADR', 'A ROM'], 'RUSSIA': ['A GAL', 'A UKR', 'F SWE', 'F NWY', 'A RUM'], 'TURKEY': ['F BLA', 'F AEG', 'A BUL', 'F CON']}
